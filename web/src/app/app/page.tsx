 ...
 * W0 proves the login → app flow and the controller → repository → mock
 * server path end to end.
 */
  ...
  return (
    ...
    >
      ...
      <p className="rounded-(--radius) border border-border bg-bg-elev p-[var(--space-4)] text-[13px] leading-[1.45] text-text-2">
        ...
        screen exists so W0 can prove login, controllers, and the mock server
        end to end.
      </p>
    </main>
  );
