...
// ~1378KB encoded / ~4787KB decoded JS (network-recorded, prod build). The
...
const RESERVED_BOX =
  "flex min-h-[calc(100dvh-var(--scalar-custom-header-height,0px))] flex-col items-center justify-center gap-3 text-[12px] text-text-2";
